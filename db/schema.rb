...
ActiveRecord::Schema.define(version: 20131215072011) do
  ...
  create_table "contacts", force: true do |t|
    ...
    t.date     "f3"
    t.datetime "f4"
    t.decimal  "f5",         precision: 10, scale: 0
    t.float    "f6"
    t.integer  "f7"
    t.integer  "f9_id"
    t.string   "f10"
  ...
  add_index "contacts", ["f9_id"], name: "index_contacts_on_f9_id", using: :btree
